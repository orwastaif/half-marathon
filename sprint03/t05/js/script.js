function forGuestlIST(){
 ...
 guestList.add(guest7);
  ...
  let menu = new Map();
  menu.set("Tabouleh", 336);
  menu.set("Fatoush", 364);
  menu.set("Falafel", 200);
  menu.set("Kebbeh", 180);
  menu.set("Foul", 250);
  menu.set("Ceacer Salad", 150);
  menu.set("shrimps", 210);
...
function forWeakMap(){
  ...
  coinCollection.set(coin1, "Lira");
  coinCollection.set(coin2, "Derham");
  coinCollection.set(coin3, "Pound");
  coinCollection.set(coin4, "Ryal");
  coinCollection.set(coin5, "Dinar");
